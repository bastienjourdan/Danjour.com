...
export default function EmoiEmoiPage() {
  const images = [
    "/Émoi Émoi/Emoi-Emoi_1.webp",
    "/Émoi Émoi/Emoi-Emoi_2.webp",
    "/Émoi Émoi/Emoi-Emoi_3.webp",
    "/Émoi Émoi/Emoi-Emoi_4.webp",
    "/Émoi Émoi/Emoi-Emoi_5.webp",
    "/Émoi Émoi/Emoi-Emoi_6.webp",
    "/Émoi Émoi/Emoi-Emoi_7.webp",
    "/Émoi Émoi/Emoi-Emoi_8.webp",
    "/Émoi Émoi/Emoi-Emoi_9.webp",
    "/Émoi Émoi/Emoi-Emoi_10.webp",
    "/Émoi Émoi/Emoi-Emoi_11.webp",
  ];
      ...
      <GridWrapper>
        <div className="flex flex-col lg:flex-row gap-16 py-8">
          <div className="lg:w-1/3">
            ...
            <p className="text-base text-text-primary mb-4">Emoi Emoi</p>
          ...
          <div className="lg:w-2/3">
            <p className="text-base leading-7 text-text-secondary">
              Direction artistique pour la marque Emoi Emoi.
            </p>
          </div>
        </div>
      </GridWrapper>
