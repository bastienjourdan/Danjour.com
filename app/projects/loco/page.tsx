  ...
  return (
    <div className="pb-24">
      ...
      <GridWrapper>
        ...
        <p className="text-sm text-gray-400 mb-8">Branding, Website — Projet personnel</p>
      </GridWrapper>
        ...
        <div className="flex flex-col lg:flex-row gap-16 py-8">
          ...
          <div className="lg:w-2/3">
            <p className="text-base leading-7 text-text-secondary">
              Projet personnel de branding et webdesign.
            </p>
          </div>
        </div>
      </GridWrapper>
      ...
      <Lightbox images={[
    "/projects/LOCO/LOCO_1.webp",
    "/projects/LOCO/LOCO_2.webp",
    "/projects/LOCO/LOCO_3.webp",
    "/projects/LOCO/LOCO_4.webp",
  ]} />
